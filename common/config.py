...
def init_config(master_addr="localhost", master_port=39901, world_size=1, local_rank=0, process_group_backend="gloo", mem_utilization_monitor_interval:float=0.5):
    c = Config()
...
@singleton
class Config:
    def __init__(self, master_addr="localhost", master_port=39901, world_size=1, local_rank=0,
                 process_group_backend="gloo", mem_utilization_monitor_interval: float = 1):
